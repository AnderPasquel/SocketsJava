                ...
                switch (reading.readUTF()) {
                    case "Reader": {
                        ...
                        try {
                            ...
                            Server.jTextArea1.append("Dirección del İP Address: " + adres + "\n");
                            Server.jTextArea1.append("Nombre del lector:" + Readeradi + "\n");
                            String durdur = "";
                            String Gönderi;
                            while (Gonder != null) {

                                synchronized (kilit) {
                                    Gönderi = readFile("Registro.server");

                                }

                                Gonder.writeUTF(Gönderi);
                                Server.jTextArea1.append("Datos enviados: " + sistemTarihiniGetir("H:mm:ss") + " ->" + Readeradi + "\n");
                    ...
                    Client.close();
                    Server.jTextArea1.append(ThreadServer.threadler[this.ThreadGelen].getName() + " Disponibilidad" + ":" + ThreadServer.threadler[this.ThreadGelen].getState() + "\n");

                    Server.jTextArea1.append("Separador de Lectores. Dirección IP: " + adres + "\n\n");
                    if ((this.ThreadGelen) != 0) {
                        Server.jTextArea1.append(ThreadServer.threadler[this.ThreadGelen - 1].getName() + " Disponibilidad" + ":" + ThreadServer.threadler[this.ThreadGelen - 1].getState() + "\n\n");
                    ...
                    case "Writer": {
                        ...
                        try {
                            ...
                            Server.jTextArea1.append("Dispositivo conectado. Dirección IP: " + Client.getLocalAddress() + "\n");
                            while ((Responseline = Al.readUTF()) != null) {
                                AlınanVeri = adres + ";" + Responseline;
                                Server.jTextArea2.append("Se conectaron desde la dirección: " + adres + "   " + AlınanVeri + "\n");
                            }
                    ...
                    Server.jTextArea1.append(ThreadServer.threadler[this.ThreadGelen].getName() + " Disponibilidad" + ":" + ThreadServer.threadler[this.ThreadGelen].getState() + "\n");
                    Client.close();
                    Server.jTextArea1.append("Dispositivo conectado. Dirección IP: " + adres + "\n\n");
                    if ((this.ThreadGelen) != 0) {
                        Server.jTextArea1.append(ThreadServer.threadler[this.ThreadGelen - 1].getName() + " Disponibilidad" + ":" + ThreadServer.threadler[this.ThreadGelen - 1].getState() + "\n\n");
